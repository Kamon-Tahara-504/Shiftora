import { CalendarDays, Lock, KeyRound, ArrowRight } from "lucide-react";
          ...
          <div className="bg-white rounded-xl shadow-xl shadow-primary/5 border border-primary/10 overflow-hidden">
            <div className="p-8 md:p-10">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500">招待を受け入れました。アカウントを利用するため、<br />ログイン用のパスワードを設定してください。</p>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-slate-100 text-center">
                <p className="text-slate-600">
                  すでにパスワードを設定済みですか？
                  <br />
                  <Link className="text-primary font-bold hover:underline" href="/login">ログイン</Link>
                </p>
              </div>
            </div>
          </div>
