import { CalendarDays, Building2, Mail, Lock, KeyRound, ArrowRight } from "lucide-react";
          ...
          <div className="bg-white rounded-xl shadow-xl shadow-primary/5 border border-primary/10 overflow-hidden">
            <div className="p-8 md:p-10">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500">Shiftoraへようこそ。<br />組織情報を入力してアカウントを作成してください。</p>
              </div>
              ...
              <form action="#" className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input className="w-full pl-12 pr-4 py-3.5 bg-background-light border-primary/20 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-slate-900 placeholder:text-slate-400" id="org-name" name="org-name" placeholder="例：株式会社シフトラ" type="text" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-slate-700 ml-1" htmlFor="password">
                      パスワード
                    </label>
                    <div className="relative group">
                      ...
                      <input className="w-full pl-12 pr-4 py-3.5 bg-background-light border-primary/20 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-slate-900 placeholder:text-slate-400" id="password" name="password" placeholder="8文字以上" type="password" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-slate-700 ml-1" htmlFor="password_confirm">
                      パスワード（確認）
                    </label>
                    <div className="relative group">
                      ...
                      <input className="w-full pl-12 pr-4 py-3.5 bg-background-light border-primary/20 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-slate-900 placeholder:text-slate-400" id="password_confirm" name="password_confirm" placeholder="もう一度入力" type="password" />
                    </div>
                  </div>
                </div>

                <div className="flex items-start gap-3 pt-2">
                  <input className="mt-1 rounded border-primary/30 text-primary focus:ring-primary" id="terms" type="checkbox" />
                  <label className="text-sm text-slate-600 leading-snug" htmlFor="terms">
                    <Link href="#" className="text-primary hover:underline font-medium">利用規約</Link>および<Link href="#" className="text-primary hover:underline font-medium">プライバシーポリシー</Link>に同意します。
                  </label>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-slate-100 text-center">
                <p className="text-slate-600">
                  すでに組織アカウントをお持ちですか？
                  <br />
                  <Link className="text-primary font-bold hover:underline" href="/login">ログインはこちら</Link>
                </p>
              </div>
            </div>
          </div>
